...
{    
    ...
    public static FadeOutScene GetInstance()
    {
    	// Get Script
        FadeOutScene fader = (FadeOutScene)Camera.main.GetComponent("FadeOutScene");
        // Check if script exists
        if (fader == null) 
        {
            Debug.LogError("No FadeOutScene attached to the main camera.");
        }    
        return fader;
	}
    ...
    public void Start()
    {
    	Debug.Log("Starting FadeOutScene");
